...
function Feedback.new(code, type, description)
    local newFeedback = {}
...
FeedbackEnum.SYMBOL_IN_ADDRESS = Feedback.new(-2, FeedbackType.ERROR, "The symbol is already present in the address.")
...
FeedbackEnum.SELF_OBSTRUCTED = Feedback.new(-7, FeedbackType.MAJOR_ERROR, "The dialing stargate is obstructed.")
FeedbackEnum.TARGET_OBSTRUCTED = Feedback.new(-8, FeedbackType.ERROR, "The target stargate is obstructed.")
FeedbackEnum.SELF_DIAL = Feedback.new(-9, FeedbackType.MAJOR_ERROR, "The stargate is dialing itself.")
FeedbackEnum.SAME_SYSTEM_DIAL = Feedback.new(-10, FeedbackType.MAJOR_ERROR, "The stargate is dialing within the same system.")
FeedbackEnum.ALREADY_CONNECTED = Feedback.new(-11, FeedbackType.MAJOR_ERROR, "The stargate is already connected.")
FeedbackEnum.NO_GALAXY = Feedback.new(-12, FeedbackType.MAJOR_ERROR, "The stargate isn't in a galaxy.")
FeedbackEnum.NO_DIMENSIONS = Feedback.new(-13, FeedbackType.MAJOR_ERROR, "There are no dimensions in the specified solar system.")
FeedbackEnum.NO_STARGATES = Feedback.new(-14, FeedbackType.MAJOR_ERROR, "There are no stargates in the specified solar system.")
...
FeedbackEnum.RAN_OUT_OF_POWER = Feedback.new(-16, FeedbackType.ERROR, "The stargate ran out of power.")
